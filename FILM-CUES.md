...
| Cue | Action |
|-----|--------|
| Screen | Landing → **Co-shop** tab → add one bag |
...
| Cue | Action |
|-----|--------|
| Screen | `src/webmcp/registerTools.ts` OR the header badge — it reads "Assistant tools active · 18 connected" with the flag on, "Assistant tools ready · open Connect to test" without |
