...
| **Field audit (ours)** | **0% GTIN** on 78/78 crawled DTC | Batch 2026-08-31 → Render KV | `GET /api/v1/render/status` |
| **Field width** | **148** curated · **78** crawled | Rankings + FIELD_RECEIPT | Connect lighthouse hero |
