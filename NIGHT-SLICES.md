...
**Morning pitch:** `demo/PITCH-TOMORROW.md`
...
**B done when:** audit returns offerPct + policySmoke; UI shows them; R7 doc exists; verify green. **✅** (B7 deferred)
...
## RC-W · WebMCP product shape

**Parent prompt:** `rc-webmcp-shape-2026-08-31` · **Cloud agent:** [RC WebMCP shape](https://cursor.com/agents/bc-538527fc-47f1-4d7c-b82c-42707dcade03)

| ID | Slice | Done when | Status |
|----|-------|-----------|--------|
| **W1** | Prove CTA after audit | `Prove in co-shop` + WebMCP scroll | ✅ |
| **W2** | Connect section labels 1–4 | Measure → Compare → Prove → Re-measure | ✅ |
| **W3** | Stranger pass WebMCP path | Path B in STRANGER-PASS | ✅ |
| **W4** | Pitch pack for morning | `demo/PITCH-TOMORROW.md` | ✅ |
