...
import { computeOfferPct, productNodeHasOffer } from './src/lib/offer-schema.ts';
...
ok('offer node detected', productNodeHasOffer(nodes[0]) === true);
ok('missing offer node rejected', productNodeHasOffer(nodes[1]) === false);
ok('offer pct is 50', computeOfferPct(nodes) === 50);
